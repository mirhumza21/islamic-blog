  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[100] focus:rounded-xl focus:bg-green focus:px-4 focus:py-2 focus:text-white"
        >
          Skip to content
        </a>
